...
const ServiceCard = ({ color, title, icons, subtitle }) => (
  <div className="flex flex-row justify-start items-center white-glassmorphism p-3 m-2 pb-5 cursor-pointer hover:shadow-xl">
    <div
      ...
      <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex-1 flex flex-col justify-start items-center">
          <ServiceCard
            ...
            icons={<BsShieldFill fontSize={21} className="text-white" />}
